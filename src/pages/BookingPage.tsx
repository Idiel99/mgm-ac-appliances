    ...
    <div className="bg-brand-light py-14">
      ...
      <div className="container space-y-6">
        <header className="space-y-2 text-center">
          <p className="text-sm font-semibold uppercase tracking-wide text-brand-primary">{copy.header.schedule}</p>
          <h1 className="text-4xl font-bold text-brand-dark">{copy.booking.title}</h1>
          <p className="text-slate-600">{copy.booking.subtitle}</p>
        </header>
        <BookingWizard />
      </div>
    </div>
